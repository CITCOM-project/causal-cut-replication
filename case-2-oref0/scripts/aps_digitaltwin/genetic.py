...
class GlucoseInsulinGeneticAlgorithm:
    ...
    def wrapped_fitness_function_stomach(self):
        ...
        def fitness_function_stomach(ga, solution, solution_idx):
    ...
    def wrapped_fitness_function_insulin(self):
        ...
        def fitness_function_insulin(ga, solution, solution_idx):
    ...
    def wrapped_fitness_function_glucose(self):
        ...
        def fitness_function_glucose(ga, solution, solution_idx):
            constants = [
                self.__kjs,
                solution[0],
                solution[1],
